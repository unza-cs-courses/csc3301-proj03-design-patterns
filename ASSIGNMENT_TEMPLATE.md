...
Welcome to Project 3! In this project, you will design and implement a reusable library demonstrating classic design patterns in Python. Your implementation should be within the **{{DOMAIN_NAME}}** domain ({{DOMAIN_CONTEXT}}).
...
| Pattern | Category | Module | Points |
|---------|----------|--------|--------|
| {{VARIANT_PATTERN_1_NAME}} | {{VARIANT_PATTERN_1_CATEGORY}} | `src/patterns/{{VARIANT_PATTERN_1_CATEGORY}}/{{VARIANT_PATTERN_1_MODULE}}.py` | 15% |
| {{VARIANT_PATTERN_2_NAME}} | {{VARIANT_PATTERN_2_CATEGORY}} | `src/patterns/{{VARIANT_PATTERN_2_CATEGORY}}/{{VARIANT_PATTERN_2_MODULE}}.py` | 15% |
...
Your implementations should use examples from a **{{DOMAIN_CONTEXT}}**. Consider using concepts like:
{{DOMAIN_EXAMPLES}}
...
2. **Concrete Implementations**
   ...
   - Use domain-relevant examples ({{DOMAIN_CONTEXT}})
...
### {{VARIANT_PATTERN_1_NAME}} ({{VARIANT_PATTERN_1_CATEGORY}})
{{VARIANT_PATTERN_1_DESCRIPTION}}

**Your task:** {{VARIANT_PATTERN_1_TASK}}

### {{VARIANT_PATTERN_2_NAME}} ({{VARIANT_PATTERN_2_CATEGORY}})
...
*This assignment was generated specifically for student {{STUDENT_ID}}. Pattern combinations are unique per student.*
